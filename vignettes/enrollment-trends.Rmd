...
## 15. The multiracial generation is growing

Multiracial students are Kentucky's fastest-growing demographic, more than tripling since 2010. This reflects national trends in multiracial identity.
...
ggplot(multiracial, aes(x = end_year, y = n_students)) +
  ...
  labs(title = "Multiracial Students in Kentucky",
       subtitle = "More than tripled since 2010",
       x = "School Year", y = "Students") +
  theme_readme()
```
