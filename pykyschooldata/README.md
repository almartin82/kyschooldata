...
Python wrapper for Kentucky school enrollment data.

This is a thin rpy2 wrapper around the [kyschooldata](https://github.com/almartin82/kyschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `kyschooldata` R package installed
...
# Fetch one year
df = ky.fetch_enr(2025)

# Fetch multiple years
df_multi = ky.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
