...
**[Full documentation](https://almartin82.github.io/kyschooldata/)** –
...
|--------------------|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| **Enrollment**     | 1997-2024 | [`fetch_enr()`](https://almartin82.github.io/kyschooldata/reference/fetch_enr.md) / [`fetch_enr_multi()`](https://almartin82.github.io/kyschooldata/reference/fetch_enr_multi.md) | State, district, school. Race, gender, FRPL, SpEd, LEP              |
| Assessments        | –         | –                                                                                                                                                                                 | Not yet available                                                   |
| Graduation         | –         | –                                                                                                                                                                                 | Not yet available                                                   |
| **Directory**      | Current   | [`fetch_directory()`](https://almartin82.github.io/kyschooldata/reference/fetch_directory.md)                                                                                     | District, school. Superintendent, principal, address, phone, grades |
...
> See
> [DATA-CATEGORY-TAXONOMY.md](https://almartin82.github.io/kyschooldata/DATA-CATEGORY-TAXONOMY.md)
...
- [Full documentation](https://almartin82.github.io/kyschooldata/) – all
  15 stories
- [Enrollment
  trends](https://almartin82.github.io/kyschooldata/articles/enrollment-trends.html)
  – 15 stories
- [Function
  reference](https://almartin82.github.io/kyschooldata/reference/)
