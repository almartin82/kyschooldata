...
enr_early <- tryCatch(
  fetch_enr_multi(2000:2005, use_cache = TRUE),
  error = function(e) {
    warning("Failed to fetch historical enrollment data: ", e$message)
    NULL
  }
)
stopifnot(!is.null(enr_early))
